<script>
    ...
    $: isDiagnostics = $location.hash === '#diagnostics';
        ...
        <ul class="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
            <li class="mr-3 flex-1">
                <a href="#diagnostics" class="block py-1 md:py-3 pl-1 align-middle text-green-600 no-underline border-b-2 border-gray-800 hover:border-green-500">
                    ...
                    <span
                        class:text-white="{isDiagnostics}"
                        class:text-gray-600="{!isDiagnostics}"
                        class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 block md:inline-block">
                        Diagnostics
                    </span>
                </a>
            </li>
