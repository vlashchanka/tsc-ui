<script>
    import { location, status, info } from './store';
</script>

<div class:hidden="{$location.hash !== '#' && $location.hash !== ''}" class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">

    <div class="bg-gray-800 pt-3">
        <div class="rounded-tl-3xl bg-gradient-to-r from-blue-500 to-gray-800 p-4 shadow text-2xl text-white">
            <h3 class="font-bold pl-2">{$info.project}</h3>
        </div>
    </div>
            ...
            <div class="bg-gradient-to-b from-blue-200 to-blue-100 border-b-4 border-blue-500 rounded-lg shadow-xl p-5">
                <div class="flex flex-row items-center">
                    ...
                    <div class="flex-1 text-right md:text-center">
                        ...
                        <h3 class="font-bold text-3xl"><span>{$status.files}</span> file(s)</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-gradient-to-b from-indigo-200 to-indigo-100 border-b-4 border-indigo-500 rounded-lg shadow-xl p-5">
                <div class="flex flex-row items-center">
                    ...
                    <div class="flex-1 text-right md:text-center">
                        ...
                        <h3 class="font-bold text-3xl"><span>{$status.messages.length}</span> problem(s)</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-gradient-to-b from-red-200 to-red-100 border-b-4 border-red-500 rounded-lg shadow-xl p-5">
                <div class="flex flex-row items-center">
                    ...
                    <div class="flex-1 text-right md:text-center">
                        ...
                        <h3 class="font-bold text-3xl">{$status.codes}</h3>
                    </div>
                </div>
            </div>
        </div>
