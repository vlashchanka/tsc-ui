<script>
    import { location, status } from './store';
</script>
...
<div class:hidden="{$location.hash !== '#diagnostics'}" class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
                ...
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200 table-auto">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            {#each $status.messages as { fileName, error, code }, i}
                                <tr>
