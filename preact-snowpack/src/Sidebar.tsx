...
function Sidebar() {
  ...
  const diagnosticsClass = navigation === Navigation.Diagnostics ? 'text-white' : 'text-gray-600';
  const homeClass = navigation === Navigation.Status ? 'text-white' : 'text-gray-600';
  return (
          ...
          <ul class="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
            <li class="mr-3 flex-1">
              <a href="#diagnostics" class="block py-1 md:py-3 pl-1 align-middle text-green-600 no-underline border-b-2 border-gray-800 hover:border-green-500">
                ...
                <span
                    class={"pb-1 md:pb-0 text-xs md:text-base block md:inline-block " + diagnosticsClass}>
                        Diagnostics
                    </span>
              </a>
            </li>
            <li class="mr-3 flex-1">
              <a href="#" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-blue-500">
                ...
                <span
                    class={"pb-1 md:pb-0 text-xs md:text-base block md:inline-block " + homeClass}>
                        Status
                    </span>
              </a>
            </li>
